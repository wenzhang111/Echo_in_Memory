...
# 统一去掉前后空格和末尾斜杠，避免出现 "https://xxx.com /repo" 这类错误URL
HF_ENDPOINT = HF_ENDPOINT.strip().rstrip("/")
EMBEDDING_LOAD_RETRY_SECONDS = int(os.getenv("EMBEDDING_LOAD_RETRY_SECONDS", "300"))
